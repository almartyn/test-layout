      ...
      <div className="main_wraper">
        ...
        <div className="main_text-and-img">
          <p>
            ...
            condimentum, malesuada nunc nec, ultricies sem. <br /> Phasellus
            tristique lacinia enim, quis iaculis purus rutrum ac. Cras non
            sapien vestibulum, semper ligula sit amet, venenatis urna. Etiam
        ...
        <Button onClick={scrollHandler}type="submit" >Lorem ipsum dolor sit amet</Button>
      </div>
    </Card>
  );
};
